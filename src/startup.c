...
/* Criando o protótipo da função main()  */
int main(void);
...
/* Continando a criação de vetores de interrupção */
...
/* Adicionando as variáveis exportadas pelo link script */
...
/* Preencher com 0 a seção .bss */
/* Chamar a função main() */
void reset_handler(void)
{   
    /* Inicializando nossa variável do loop */
    uint32_t i;

    /* Copiando a seção .data para a RAM */
    ...
    /* Preechendo a seção .bss com zero */
